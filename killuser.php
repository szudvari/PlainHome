...
if ($_SESSION["admin"] > 0)
{
   ...
   <table id="responsiveTable" class="large-only" cellspacing="0">
    ...
    <td>{$user['floor']}</td>
    <td>{$user['door']}</td>
    <td><button type="input" name="submit" value="töröl" class="btn btn-danger btn-icon"><i class="fa fa-times"></i>Törlés</button><span class="pwarning">Figyelem! Nem visszavonható!</span></td>
    </tr>
    </tbody>
    </table>
    </form>
